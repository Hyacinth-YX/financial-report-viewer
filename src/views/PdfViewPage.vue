                    ...
                    >
                        <q-tab-panel name="index">
                            ...
                            <div class="q-pa-md row q-col-gutter-sm">
                                <report-index :tree-data.sync="treeData"/>
                            </div>
                        </q-tab-panel>
                        ...
                        <q-tab-panel name="history">
                            ...
                            <report-history :selectStr="selectStr"></report-history>
                        </q-tab-panel>
                    </q-tab-panels>
                </template>
            </q-splitter>
...
<script scoped>
    ...
    export default {
        name: "PdfViewPage",
        components: {reportRelation, reportIndex, reportEmotion, reportEntity, reportSearch, reportHistory},
        watch: {
            searchText: function () {
                this.tab = "search"
            }
                ...
                treeData: [{
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            {text:"发展战略及核心竞争力",children:{text:"本行发展战略",children: [{text:"本行以打造“中国最卓越、全球领先的智能化零售银行”为战略目标，持续坚持“科技引领、零\n" +
